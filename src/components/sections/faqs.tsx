                ...
                <div className="row">
                    <div className="col-lg-4 col-md-6">
                        <div className="book-call-intro text-center">
                            <Image width={140} height={140} src="/images/about/founder.webp" alt="founder" title="founder" />
                            <h2>Book a 15-minute intro call</h2>
                            <a href="#" className="theme-btn">Schedule now<i className="ri-video-chat-line" /></a>
                            <p>Prefer to email? <a href="mailto:huzaifa.fullstack@gmail.com">huzaifa.fullstack@gmail.com</a></p>
                        </div>
                    </div>
