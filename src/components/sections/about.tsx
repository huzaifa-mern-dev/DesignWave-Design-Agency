                ...
                <div className="row">
                    <div className="col-lg-12">
                        <SlideUp className="founder-say-part text-center">
                            <h3>DesignWave took my billion-dollar baby idea, slapped their design magic on it, and boom
                            ...
                            <div className="founder-name-part">
                                <Image width={80} height={80} src="/images/about/founder.webp" alt="founder" title="founder" />
                                <h2>Muhammad Huzaifa</h2>
                                <p>Founder of DesignWave</p>
                            </div>
                        </SlideUp>
                    </div>
                </div>
